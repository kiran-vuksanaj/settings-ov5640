...
OV5640_SIZE_HDSUB4 = 18 # 320x180, custom added by kiran
OV5640_SIZE_HDSUB4_PORTRAIT = 19 # 180x320, custom added by kiran
OV5640_SIZE_HDSUB2 = 20 # 640x360, custom added by kiran
...
_resolution_info = [
    ...
    [320, 180, _ASPECT_RATIO_16X9], # HDSUB4
    [180, 320, _ASPECT_RATIO_9X16], # HDSUB4_PORTRAIT
    [640, 360, _ASPECT_RATIO_16X9], # HDSUB2
]
    ...
    def _set_size_and_colorspace(self) -> None:  # pylint: disable=too-many-locals
        ...
        if self.colorspace == OV5640_COLOR_JPEG:
            ...
            if size > OV5640_SIZE_HVGA:
                ...
                self._set_pll(False,20, 1, 1, False, 1, True, 4)
